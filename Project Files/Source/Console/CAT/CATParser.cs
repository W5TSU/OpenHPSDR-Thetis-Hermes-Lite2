...
//					break;
				...
				case "ZZPZ":
					...
					break;
                case "ZZDV":
                    rtncmd = cmdlist.ZZDV(suffix);
                    break;
                case "ZZEF":
                    rtncmd = cmdlist.ZZEF(suffix);
                    break;
                case "ZZEG":
                    rtncmd = cmdlist.ZZEG(suffix);
                    break;
                case "ZZDS":
                    rtncmd = cmdlist.ZZDS();
                    break;
                ...
                case "ZZTC":
                    ...
                    break;
                case "ZZQA":
                    rtncmd = cmdlist.ZZQA(suffix);
                    break;
                case "ZZQB":
                    rtncmd = cmdlist.ZZQB(suffix);
                    break;
                case "ZZQK":
